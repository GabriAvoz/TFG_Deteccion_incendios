...
public class ChartNode2 extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject>{

    String choice;
    RequestQueue requestQueue;
    JsonObjectRequest query;
    String URL = "http://192.168.1.57/tfg_db/get_measurements_node2.php";
    LineChart mChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chart_node2);

        choice = getIntent().getExtras().getString("sensor");
        mChart = findViewById(R.id.chart_node2);
    ...
    public void onResponse(JSONObject response) {
        ...
        JSONArray json = response.optJSONArray("node2");
    ...
    private void setData(){
        ...
        LineDataSet set1 = new LineDataSet(list1, "Node 2");
